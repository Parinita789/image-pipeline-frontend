...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      {/* Left — visual showcase panel (matches Register) */}
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-gradient-to-b from-white to-indigo-50/30">
        <div className="w-full max-w-[400px]">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 mt-1.5 text-[15px]">Sign in to your Pixelift account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link to="/forgot-password" className="text-[12px] text-indigo-600 hover:text-indigo-700 font-medium transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
