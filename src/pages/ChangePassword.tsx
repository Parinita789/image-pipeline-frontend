    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 px-6">
        <div className="w-full max-w-[400px] text-center animate-[fadeIn_0.4s_ease-out]">
          ...
          <p className="text-gray-500 text-[15px]">Redirecting you to dashboard...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-indigo-50/30 px-6">
      <div className="w-full max-w-[400px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* Current Password */}
          <div>
            <label className="block text-[13px] text-gray-600 mb-1.5 font-medium">Current password</label>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          <Link to="/" className="inline-flex items-center gap-1.5 text-indigo-600 hover:text-indigo-700 font-semibold transition-colors">
